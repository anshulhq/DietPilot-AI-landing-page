...
export default function PlayfulOrange() {
  ...
  const handleCharacterClick = () => {
    ...
    gsap.timeline()
      .to(characterRef.current, { scaleX: 1.3, scaleY: 0.7, duration: 0.1, ease: "power2.out" })
      .to(characterRef.current, { scaleX: 0.8, scaleY: 1.2, duration: 0.15, ease: "power2.inOut" })
      .to(characterRef.current, { scaleX: 1, scaleY: 1, duration: 1, ease: "elastic.out(1.2, 0.3)" });
    
    // Heart Pop-up
    const heart = document.getElementById("orange-heart");
    if (heart) {
  ...
  return (
    <div ref={containerRef} className="py-32 flex flex-col items-center justify-center relative overflow-hidden bg-surface/5">
      ...
      <div className="text-center mb-16 relative z-10">
        <h3 className="text-3xl font-black tracking-tight uppercase mb-3 text-orange-400">Fresh Perspective</h3>
        <p className="text-white/40 text-lg font-medium max-w-md mx-auto">
          Our interface is as refreshing as a freshly squeezed orange. Simple, sweet, and vital.
        </p>
      </div>

      <div className="relative [perspective:1000px] cursor-pointer" onClick={handleCharacterClick}>
        <div id="orange-heart" className="absolute top-0 left-1/2 -translate-x-1/2 pointer-events-none opacity-0 z-50">
        ...
        <svg 
          ref={characterRef}
          viewBox="0 0 200 200" 
          className="w-56 h-auto drop-shadow-[0_20px_40px_rgba(255,165,0,0.2)] relative z-10"
        ...
        >
          ...
          {/* Stem & Leaf (Top) */}
          <g ref={leafRef}>
            <path d="M100 40 L100 25" stroke="#4d2600" strokeWidth="4" strokeLinecap="round" />
            <path d="M100 30 Q 120 10, 140 30 Q 120 40, 100 30" fill="#4CAF50" />
          </g>

          {/* Face Layer */}
          <g ref={faceRef}>
            <g ref={blushRef} opacity="0.4">
              <ellipse cx="65" cy="105" rx="10" ry="5" fill="#FFDAB9" />
              <ellipse cx="135" cy="105" rx="10" ry="5" fill="#FFDAB9" />
            </g>

            <path 
              ref={mouthRef}
              d="M90 115 Q 100 125, 110 115" 
              fill="none" 
              stroke="#4d2600" 
              strokeWidth="3" 
              strokeLinecap="round" 
            ...
            <g ref={eyesRef}>
              <g>
                ...
                <circle cx="75" cy="90" r="5" fill="#331a00" />
                <circle cx="72" cy="87" r="2" fill="white" />
              </g>
              <g>
                <circle cx="125" cy="90" r="10" fill="white" />
                <circle cx="125" cy="90" r="5" fill="#331a00" />
