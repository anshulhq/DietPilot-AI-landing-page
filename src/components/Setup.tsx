...
const steps = [
  {
    ...
    icon: Terminal,
    content: (
      <div className="bg-obsidian/50 p-4 rounded-xl font-mono text-sm border border-white/5 space-y-2">
    ...
    content: (
      <div className="space-y-4">
        <p className="text-white/60 text-sm">
          Download the Food.com Recipes dataset from Kaggle and place <code className="text-brand-primary">recipes.csv</code> inside the backend/ directory.
        </p>
        <a 
        ...
        >
          KAGGLE DATASET <ExternalLink size={12} />
        </a>
      </div>
    ),
  },
  {
    ...
    icon: Server,
    content: (
      <div className="bg-obsidian/50 p-4 rounded-xl font-mono text-xs border border-white/5 space-y-2 max-h-40 overflow-y-auto">
        <div className="text-white/40"># Install & Run</div>
        ...
        <div className="text-white/40 pt-2"># Initialize DB</div>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-obsidian/50 p-4 rounded-xl font-mono text-xs border border-white/5 space-y-1">
    ...
    <section id="setup" className="py-32 px-6 max-w-7xl mx-auto relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(200px,auto)]">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="md:col-span-7 glass p-8 rounded-[2.5rem] border border-white/10 relative overflow-hidden group flex flex-col justify-between"
        >
        ...
        <motion.div
          ...
          className="md:col-span-5 glass p-8 rounded-[2.5rem] border border-white/10 relative overflow-hidden group flex flex-col justify-between"
        >
        ...
        <motion.div
          ...
          className="md:col-span-5 glass p-8 rounded-[2.5rem] border border-white/10 relative overflow-hidden group flex flex-col"
        >
